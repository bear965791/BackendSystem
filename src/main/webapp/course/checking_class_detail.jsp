        ...
        <div class="col-10  mb-4">
            ...
            <nav class="nav_second mb-2 "> 
                <div class="nav d-flex align-items-center border-bottom border-top">
                    ...
                    <a class="nav-link" href="./notcheckList.html">課程審核</a>
                    <i class="fa fa-angle-right" aria-hidden="true"></i>
            ...
            <div class="container">
                ...
                <div class="d-flex justify-content-center ">
                    <button type="button" class="btn btn-outline-dark me-2">通過</button>
                    <button type="button" class="btn btn-outline-dark ms-2">拒絕</button>
                </div>
            </div>
        </div>
